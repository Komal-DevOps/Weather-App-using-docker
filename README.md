...
This is a simple Weather Web Application built using HTML, CSS, and JavaScript, and containerized using Docker. The app allows users to check real-time weather information for any city.
